# Mandatory GUI Libraries
from PyQt5 import QtCore, QtGui, QtWidgets
from PyQt5.QtCore import Qt, QRect, QPropertyAnimation, QSequentialAnimationGroup

# For Database Connection Libraries
import pymysql as sql

# For Resources Library Such as Icons
import Resources

#Library for Dark Mode Assistance
import qdarkstyle

# Self Made Classes Required
from Data_Extractor import DB_Data

# Implementing Class and its function for TDL UI
class TDLMain(object):
        def __init__(self,maximized, Team_Name, New_Members, Total_Assignments, Evaluation_points, Writer_Name, Writer_Image, Writer_Email, Writer_Contact_No, Writer_Gender, Writer_Age, Writer_Biography, Writer_Role, Writer_team_leader):
                ...
                self.add_Team_Leader_in_Evaluation_Form(self.Writer_team_leader)
...
if __name__ == "__main__":
    ...
    ui = TDLMain(False, str(GetData.writer_team_name),"5", '15', str(GetData.writer_evaluation_points), str(GetData.writer_fullname),f"F:\\Visual Code Stuff\\Design_For_FCS_Portal\\Images\\writer_image.png",str(GetData.writer_email),str(GetData.writer_phone),str(GetData.writer_gender),'24',str(GetData.writer_description),str(GetData.writer_jobe_role),str(GetData.writer_team_leader))
    sys.exit(app.exec_())