...
class WriterMain(object):
        ...
        def maximizewindow(self):
                ...
                if not self.maximized:
                        ...
                        self.animeshrink.setEndValue(QRect(int(GetSystemMetrics(0)/5-100),int(GetSystemMetrics(1)/9),int(GetSystemMetrics(0)/1.5),int(GetSystemMetrics(1)/1.5)))
