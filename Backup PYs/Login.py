        ...
        def OnclickLogin(self):
                ...
                if self.lineEdit.text() == "" or self.lineEdit_2.text() == "":
                        ...
                        if record[12] != "Team Leader": 
                                ...
                                self.ui.add_data_in_manage_leave_table()
                                self.ui.add_Team_Leader_in_Evaluation_Form(str(GetData.writer_team_leader))
                                self.ui.loaddata()
                        else:
                                self.MessageOnLogin.setText("Login Succesful")
                                self.MessageOnLogin.setStyleSheet("color: darkgreen;")
...
class DB_Data:
        ...
        def getdatafrom(self):
                ...
                self.writer_new_members = record[19]
